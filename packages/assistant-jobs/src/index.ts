...
export const ASSISTANT_JOB_CAPABILITIES = [
  ...
  capability({
    ...
    label: "Create result",
    summary: "Create a scan-friendly review result.",
    ...
    manualRunSafe: true,
    requiresSetup: [],
    userFacingReadSummary: "Reads scoped project and task context.",
    userFacingWriteSummary: "Creates a review result.",
  ...
  capability({
    ...
    userFacingWriteSummary: "Creates a task.",
  ...
  capability({
    ...
    summary: "Add an Assistant activity item.",
    category: "mission_control",
    sideEffect: "write_internal_active",
    approvalMode: "none",
    eventSafe: true,
    ...
    userFacingWriteSummary: "Creates an Assistant activity item.",
  ...
  capability({
    ...
    pluginId: "me3.mission-control",
    label: "Read project",
    summary: "Read scoped project state.",
    category: "mission_control",
    sideEffect: "read_private",
    approvalMode: "none",
    eventSafe: true,
    manualRunSafe: true,
    requiresSetup: [],
    userFacingReadSummary: "Reads scoped project state.",
    userFacingWriteSummary: "Does not change owner data.",
  ...
  capability({
    ...
    manualRunSafe: true,
    requiresSetup: [],
    userFacingReadSummary: "Reads scoped tasks.",
    userFacingWriteSummary: "Does not change owner data.",
  ...
  capability({
    ...
    summary: "Read pending approvals.",
    category: "mission_control",
    sideEffect: "read_private",
    approvalMode: "none",
    eventSafe: true,
    manualRunSafe: true,
    requiresSetup: [],
    userFacingReadSummary: "Reads pending approvals.",
    userFacingWriteSummary: "Does not change owner data.",
  ...
  capability({
    ...
    userFacingWriteSummary:
      "Runs a configured local executor command and records the result in Assistant activity.",
...
export const ASSISTANT_JOB_STARTER_RECIPES = [
  {
    ...
    defaultDraft: draft({
      name: "Weekly Review",
      purpose:
        "Prepare a weekly project and task review with carry-over choices.",
  ...
  },
  {
    ...
    defaultDraft: draft({
      name: "Daily Briefing",
      purpose:
        "Sends a customised message to your Assistant or Soulink when connected.",
...
export function validateAssistantJobDraft(
  ...
  if (draft.destination.kind !== "mission_control") {
    errors.push({
      ...
      message: "Assistant Jobs must use the ME3 results destination in Core v1.",
      blocking: true,
    });
  }
